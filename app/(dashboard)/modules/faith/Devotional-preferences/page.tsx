        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
          ...
          <div className="w-full sm:max-w-[350px] lg:max-w-[700px] mx-auto">
            <div className="flex items-center justify-center my-4 px-4 py-2 w-[80px] rounded-[10px] cursor-pointer hover:opacity-90 active:scale-95 transition-all bg-[conic-gradient(from_236.3deg_at_92.05%_3.9%,_#300878_-5.19deg,_#5A3FFF_133.27deg,_#D4AF37_254.42deg,_#300878_354.81deg,_#5A3FFF_493.27deg)]">
              <p className="text-xs sm:text-base text-white m-0 font-medium">Go!</p>
            </div>
                  ...
                  <div className="absolute top-0 right-0 mt-4 w-100 z-50 border border-gray-200 rounded-xl shadow-lg bg-white p-4 space-y-2">
                    ...
                    <div className="max-h-60 overflow-y-auto pr-2">
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          value="The Trinity"
                          selectedValue={trinity}
                          onChange={() => setTrinity("The Trinity")}
                        />
                      ...
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          value="Deity and Humanity of Christ"
                          selectedValue={christ}
                          onChange={() => setChrist("Deity and Humanity of Christ")}
                        />
                      ...
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          value="Salvation by Grace"
                          selectedValue={salvation}
                          onChange={() => setSalvation("Salvation by Grace")}
                        />
                      ...
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          value="The Authority of Scripture"
                          selectedValue={scripture}
                          onChange={() => setScripture("The Authority of Scripture")}
                        />
                      ...
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          value="The Resurrection and Return of Christ"
                          selectedValue={resurrection}
                          onChange={() => setResurrection("The Resurrection and Return of Christ")}
                        />
                      ...
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          value="Humanity's Need"
                          selectedValue={humanity}
                          onChange={() => setHumanity("Humanity's Need")}
                        />
                      ...
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          value="Ordinances"
                          selectedValue={ordinances}
                          onChange={() => setOrdinances("Ordinances")}
                        />
                      ...
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          ...
                          selectedValue={holySpirit}
                          onChange={() => setHolySpirit("The Holy Spirit")}
                        />
                      ...
                      <div className="flex flex-row items-center gap-2 my-5">
                        <CustomRadioButton
                          value="Creation"
                          selectedValue={creation}
                          onChange={() => setCreation("Creation")}
                        />
