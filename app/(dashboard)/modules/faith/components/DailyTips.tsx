...
interface DailyTipsProps {
  dailyTip: DailyTip;
  tipsIcon: string | StaticImageData;
  title?: string;
}
...
export default function DailyTips({
  ...
  return (
    <div className="bg-[#F6F0E9] rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-md w-full sm:w-auto">
      ...
      <ul className="space-y-2 sm:space-y-3">
        <li className="flex gap-2">
          ...
          <div>
            ...
            <p className="text-[#6D5F4B] font-bold text-xs sm:text-sm mt-1">
              {dailyTip.bibleverse}
            </p>
          </div>
        </li>
      ...
      <div className="flex justify-end">
        <h2 className="text-[#656565] text-sm sm:text-base font-bold underline underline-offset-4 cursor-pointer mb-2">
          Read more...
        </h2>
      </div>
    </div>
