    ...
    <div className="flex flex-col h-full">
      ...
      <main className="flex-1 overflow-auto max-w-[1200px] mx-auto scrollbar-hide w-full">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
          ...
          <div className="my-40">
            <h5 className="text-bold text-medium text-[#000000] text-center">
            ...
            <InputFooterWithMic
              ...
              onSend={(message) => {
                ...
                router.push(`/home/help-center-chat?prompt=${encodedPrompt}`);
              }}
              onAttach={() => {}}
              context="general"
            />
            ...
            <div className="ml-10 mt-2">
              ...
              <h5 className="text-medium text-[#3566A2] underline py-2">
                Where do I find the Career Module?
              </h5>
              <h5 className="text-medium text-[#3566A2] underline py-2">
                How to use the finance module.
              </h5>
            </div>
          </div>
        </div>
