...
export default function SettingsHeader({ title = "Home", icon }: HeaderProps) {
      ...
      <div className="flex items-center justify-between py-3 sm:py-4">
        ...
        <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
          ...
          <button
            ...
            aria-label="Settings"
          >
            <SettingsIcon className="h-4 w-4 sm:h-5 sm:w-5 text-black" />
          </button>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isProfileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-44 sm:w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                ...
                >
                  <SettingsIcon className="h-4 w-4" color="black" />
                  Settings
                </button>
